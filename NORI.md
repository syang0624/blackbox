...
- [ ] **End-to-end with Steven's backend** — Full flow test: type complaint → watch graph build → IVR plays → hold → handoff moment
...
- [ ] **Demo dry run** — Run through the full demo script (PRD §18) with Steven

---

## Key Interfaces with Steven

| What Nori needs from Steven | Format |
|---|---|
